...
public class LoadACLOperation extends BaseVomsOperation {
    ...
    public static LoadACLOperation instance(String contextString, boolean defaultACL) {
    ...
    protected Object doExecute() {
        ...
        VOMSContext context = (VOMSContext) FindContextOperation.instance( contextString ).execute();
        
        if (defaultACL && PathNamingScheme.isQualifiedRole( contextString ))
            throw new IllegalArgumentException("Role contexts do not have default ACLs!");
    ...
    protected void setupPermissions() {
        ...
        addRequiredPermission( VOMSContext.instance( contextString ), VOMSPermission.getEmptyPermissions().setACLReadPermission() );
        
        if (defaultACL)
            addRequiredPermission( VOMSContext.instance( contextString ), VOMSPermission.getEmptyPermissions().setACLReadPermission().setACLDefaultPermission() );
    }
