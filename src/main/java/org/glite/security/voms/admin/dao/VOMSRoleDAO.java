...
public class VOMSRoleDAO {
    ...
    public int countMatches( String searchString ) {
        ...
        Long count = (Long) HibernateFactory.getSession().createQuery(
                query ).setString( "searchString", sString ).uniqueResult();
    ...
    public VOMSRole findById( Long id ) {
        ...
        return (VOMSRole) HibernateFactory.getSession().load( VOMSRole.class,
                id );
    }
    ...
    public void deleteAll() {
        ...
        HibernateFactory.getSession()
                .createQuery( "delete from org.glite.security.voms.admin.model.VOMSRole" ).executeUpdate();
    ...
    public VOMSRoleAttribute createAttribute( VOMSRole r, VOMSGroup g,
        ...
        VOMSRoleAttribute val = VOMSRoleAttribute.instance( desc,
                attrValue,g,r );
    ...
    public void deleteAttributeByName( VOMSRole r, VOMSGroup g, String attrName ) {
        ...
        if (attr == null)
            throw new NoSuchAttributeException("Attribute '"+attrName+"' not defined for role '"+r.getName()+"' in group '"+g+"'.");
