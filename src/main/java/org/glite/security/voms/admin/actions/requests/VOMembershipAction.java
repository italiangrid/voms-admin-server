...
import org.glite.security.voms.admin.actionforms.VOMembershipActionForm;
...
public class VOMembershipAction extends BaseDispatchAction {

    public ActionForward approve( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response ) throws Exception {
    
        VOMembershipActionForm vForm = (VOMembershipActionForm)form;
        
        ApproveVOMembershipOperation.instance( vForm.getRequestId() ).execute();
    ...
    public ActionForward reject( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response ) throws Exception {
        ...
        RejectVOMembershipOperation.instance( vForm.getRequestId() ).execute();      
