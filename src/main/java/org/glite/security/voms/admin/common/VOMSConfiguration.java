...
public final class VOMSConfiguration {
    ...
    private void configureLogging(){
        ...
        if (context!=null){
            ...
            try {
                ...
                InputStream is = context.getResourceAsStream( "/WEB-INF/classes/log4j.runtime.properties" );
    ...
    private void loadServiceProperties(){
        ...
        try {
            ...
            throw new VOMSConfigurationException(
                    "Error loading service properties from "+fileName ,
                    e );
    ...
    private String getVomsServicePropertiesFileName() {
        ...
        String fileName = config.getString( "GLITE_LOCATION_VAR" ) + "/etc/voms-admin/"
        + getVOName() + "/voms.service.properties";
    ...
    private String getVomsDatabasePropertiesFileName() {
        ...
        String fileName = config.getString( "GLITE_LOCATION_VAR" ) + "/etc/voms-admin/"
        + getVOName() + "/voms.database.properties";
    ...
    public Properties getDatabaseProperties(){
        ...
        try {
            ...
            log.fatal("Error loading database properties: "+e.getMessage(),e);
    ...
    private String loadVomsesConfigurationString(){
        ...
        String vomsesConfFileName = getString( "GLITE_LOCATION_VAR" )+"/etc/voms-admin/"+getVOName()+"/vomses";
        ...
        try{
            ...
            log.fatal("Error loading vomses configuration file:"+e.getMessage(),e);
     ...
     * (non-Javadoc)
     * 
     * @see org.apache.commons.configuration.Configuration#setProperty(java.lang.String,
     *      java.lang.Object)
     */
