...
public class Participation implements Serializable {
	...
	// FIXME: This subexperiment is expressed as a name here since this column can contain the value '-' which doesn't have
	// a corresponding entry in the EXPERIMENTS table. This seems broken referential integrity in the ORGDB voms view, so it's
	// safer to just put here the subexperiment name (mostly null, btw) and let interested people do the join by hand.
	...
	/**
	 * @param greybook the greybook to set
	 */
	...
	/**
	 * @param vomsPerson the vomsPerson to set
	 */
	...
	public String toString() {
		StringBuilder builder = new StringBuilder();
		builder.append("Participation [endDate=").append(endDate).append(
				", experiment=").append(experiment).append(", getStartDate()=")
