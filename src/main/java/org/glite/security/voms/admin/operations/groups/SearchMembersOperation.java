...
public class SearchMembersOperation extends BaseMemberhipReadOperation {
    ...
    protected Object doExecute() {
        ...
        if (!__context.isGroupContext())
            return VOMSRoleDAO.instance().searchMembers(__context.getGroup(),__context.getRole(),searchString,firstResult,maxResults);
        
        return VOMSGroupDAO.instance().searchMembers(__context.getGroup(), searchString,firstResult,maxResults);
