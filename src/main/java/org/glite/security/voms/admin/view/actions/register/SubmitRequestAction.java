...
public class SubmitRequestAction extends RegisterActionSupport {
	...
	public String execute() throws Exception {
		...
		EventManager.dispatch(new VOMembershipRequestSubmittedEvent(request,confirmURL, cancelURL));
	...
	private String buildCancelURL() {
		...
		return getBaseURL()+"/register/cancel-request.action?requestId="+getModel().getId()+"&confirmId="+getModel().getConfirmId();
	...
	private String buildConfirmURL() {
		...
		return getBaseURL()+"/register/confirm-request.action?requestId="+getModel().getId()+"&confirmId="+getModel().getConfirmId();
