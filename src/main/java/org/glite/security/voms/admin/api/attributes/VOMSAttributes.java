...
public interface VOMSAttributes {
     ...
     * @param description, a description associated to the attribute
     * @param uniquenessChecked, a flag that enables the uniqueness checking of attribute 
     * values between users.
     * 
     * @throws VOMSException, if something goes wrong.
     */
    public void createAttributeClass(String name, String description, boolean uniquenessChecked)
     ...
     * @throws VOMSException
     */
    public void createAttributeClass(String name)
        throws VOMSException;
     ...
     * @throws VOMSException
     */
    public void deleteAttributeClass(String name)
        throws VOMSException;
     ...
     * @throws VOMSException
     */
    public void deleteGroupAttribute(String groupName, AttributeValue attributeValue)
        throws VOMSException;
     ...
     * @throws VOMSException
     */
    public void setRoleAttribute(String groupName, String roleName, AttributeValue attributeValue)
    	throws VOMSException;
     ...
     * @throws VOMSException
     */
    public void deleteRoleAttribute(String groupName, String roleName, AttributeValue attributeValue)
        throws VOMSException;
