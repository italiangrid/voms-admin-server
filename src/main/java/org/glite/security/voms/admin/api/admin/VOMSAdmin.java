...
public interface VOMSAdmin {
     ...
     * The user attributes are returned in a <code>User</code> object.
     *
     * <p><b>Permission:</b> LIST on the VO group.
     *
     ...
     */
    public User getUser (String username, String userca)
        throws VOMSException;
    
    /** 
     * Updates auxiliary information about a user in the VOMS database.
     * The new attributes are passed in the <code>User</code> object.
     *
	...
	/** 
	 * Removes a user from the VOMS database.  Deletes all the associated
     * group, role membership information and corresponding ACL entries as
     * well.  It is basically a call to <code>removeMember(VO, user)</code>.
     * 
     * <p><b>Permission:</b> REMOVE on the VO group.
     * 
     * @see #removeMember
	 * 
     * @param username The user's DN.
     * @param userca The user's CA.
	 */
	public void deleteUser (String username, String userca)
        throws VOMSException;

	/** 
	 * Creates a new group as a subgroup of an existing group.  Copies the
     * default ACL list of the parent to the new group and adds an extra entry
     * for the administrator with full privileges.
     * 
     * <p><b>Permission:</b> CREATE on parent group.
     * 
	 * @param parentname The parent group's name.
	...
	/** 
	 * Deletes a group.  The operation deletes the group, all of its sub-groups
     * and associated roles with all the membership information.
     * 
     * <p><b>Warning:</b> Deleting the VO "group" effectively 
     * wipes out the whole database, so use with care!
     *
     * <p><b>Permission:</b> DELETE on the group.
     *
	 * @param groupname	The group's name.
	 */
	...
	/** 
	 * Creates a new role.  Copies the default ACL list of the VO Group to the
     * new role and adds an extra entry for the administrator with full
     * privileges.
     *
     * <p><b>Permission:</b> CREATE on the VO group.
	 * 
	...
	/** 
	 * Deletes a role.  The role is removed with all the membership
     * information.
     *
     * <p><b>Permission:</b> DELETE on the role.
     *
	...
	/** 
	 * Creates a new capability.  Copies the default ACL list of the VO to the
     * new capability and adds an extra entry for the administrator with full
     * privileges.
     *
     * <p><b>Permission:</b> CREATE on the VO group.
	 * 
	 * @param capability The capability to be created.
	 */
	public void createCapability (String capability)
        throws VOMSException;
     ...
     * information.
     *
     * <p><b>Permission:</b> DELETE on the capability.
     *
	 * @param capability The capability to be deleted.
	 */
	public void deleteCapability (String capability)
        throws VOMSException;
     ...
     *
     * <p><b>Permission:</b> ADD on the group.
     * 
     * @param groupname	The group's name.
     * @param username The user's DN.
     * @param userca The user's CA.
	...
	/** 
	 * Removes a member of a group.  Also removes the membership information
     * from the group's sub-groups and associated roles of these groups. If it
     * is the VO group, then it will also delete the user with all its ACL
     * entries.
     *
     * <p><b>Permission:</b> REMOVE on the group.
     *
     * @see #deleteUser
     *
	 * @param groupname	The group's name.
     ...
     * The user must be a member of the parent group.
     * 
     * <p><b>Permission:</b> ADD on the role.
     * 
     * @param groupname		The name of the group associated with this assignment.
     * @param rolename      The role's name.
     * @param username	    The name of the user to add.
     * @param userca		The CA of the user to add.
     */
    public void assignRole (String groupname, 
                            String rolename, 
                            String username, 
                            String userca)
        throws VOMSException;
     ...
     *
     * <p><b>Permission:</b> REMOVE on the role.
     * 
	 * @param parentname	The parent group's name.
     * @param rolename      The role's name.
     * @param username The user's DN.
     * @param userca The user's CA.
	 */
	public void dismissRole (String parentname, 
                             String rolename, 
                             String username, 
                             String userca)
        throws VOMSException;
     ...
     *
     * <p><b>Permission:</b> ADD on the capability.
     * 
     ...
     *
     * <p><b>Permission:</b> REMOVE on the capability.
     * 
     * @param capability    The capability's name.
     * @param username The user's DN.
     * @param userca The user's CA.
	 */
	public void dismissCapability (String capability, String username, String userca)
        throws VOMSException;

	/** 
	 * Lists members of a group.
     *
     * <p><b>Permission:</b>LIST on the group.
     * 
	 * @param groupname	The group's name (null is the VO group).
	 * @return List of users in this group.
	 */
	public User[] listMembers (String groupname)
        throws VOMSException;

	/** 
	 * Lists assigned users of a role associated with a group.
     *
     * <p><b>Permission:</b>LIST on the role.
     * 
     * @param groupname 	The group's name.
	 * @param rolename	    The role's name.
     ...
     *
     * <p><b>Permission:</b>LIST on the capability.
     * 
	 * @param capability	    The capability's name.
     ...
     * The first element is the VO group and the last
     * is the group itself. There is at least one element
     * in this path if the group exists: the VO group.
     *
     * <p><b>Permission:</b>LIST on parent groups.
     * 
	 * @param groupname	The group's name (null is the VO group).
	 ...
	 */
	public String[] listSubGroups (String groupname)
        throws VOMSException;
     ...
     * 
     * <p><b>Permission:</b> GETACL on the container.
	 * 
	 * @param container	The container's name (null is the VO group).
	 * @return The access control list.
	 */
	public ACLEntry[] getACL (String container)
        throws VOMSException;

    /** 
     * Replaces the existing ACL on this container.
     *
     * <p><b>Permission:</b> SETACL on the container.
     * 
     ...
     * 
     * @param container	The container's name.
     * @param aclEntry	The new access control list entry.
     */
     ...
     *
	 * @param container	The container's name.
	 * @param aclEntry	The access control list entry to be removed.
	 */
	public void removeACLEntry (String container, ACLEntry aclEntry)
        throws VOMSException;

	/** 
	 * Manipulates the default ACL, which is applied on every group
     * created as a subgroup of this one.
     * @see #getACL
	 * 
	 * @param groupname	The group's name.
	 * @return The access control list.
	 */
	public ACLEntry[] getDefaultACL (String groupname)
        throws VOMSException;
	 ...
	 * 
	 * @param groupname	The group's name.
	 * @param aclEntry	The new access control list.
	 */
