...
public interface VOMSAdmin {
	...
	/**
	 * Returns information about a user in the VOMS database. The user
	 * attributes are returned in a <code>User</code> object.
	 * 
	 * <p>
	 * <b>Permission:</b> LIST on the VO group.
	 * 
	 ...
	 *            The user's CA.
	 */
	public void dismissRole(String parentname, String rolename,
			String username, String userca) throws VOMSException;
	...
	/**
	 * Returns the absolute "path" down to this group. The first element is the
	 * VO group and the last is the group itself. There is at least one element
