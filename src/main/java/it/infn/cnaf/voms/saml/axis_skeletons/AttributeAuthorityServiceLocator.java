...
public class AttributeAuthorityServiceLocator extends org.apache.axis.client.Service implements it.infn.cnaf.voms.saml.axis_skeletons.AttributeAuthorityService {
    ...
    public AttributeAuthorityServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public AttributeAuthorityServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }
    ...
    public it.infn.cnaf.voms.saml.axis_skeletons.AttributeAuthorityPortType getAttributeAuthorityPortType(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            it.infn.cnaf.voms.saml.axis_skeletons.AttributeAuthoritySoapBindingStub _stub = new it.infn.cnaf.voms.saml.axis_skeletons.AttributeAuthoritySoapBindingStub(portAddress, this);
    ...
    public void setAttributeAuthorityPortTypeEndpointAddress(java.lang.String address) {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (it.infn.cnaf.voms.saml.axis_skeletons.AttributeAuthorityPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                it.infn.cnaf.voms.saml.axis_skeletons.AttributeAuthoritySoapBindingStub _stub = new it.infn.cnaf.voms.saml.axis_skeletons.AttributeAuthoritySoapBindingStub(new java.net.URL(AttributeAuthorityPortType_address), this);
                _stub.setPortName(getAttributeAuthorityPortTypeWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://voms.cnaf.infn.it", "AttributeAuthorityService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://voms.cnaf.infn.it", "AttributeAuthorityPortType"));
        }
