...
<div class="reloadable">
      ...
      <s:if test="not #attr.unsubscribedGroups.empty">
        ...
        <div class="subscribeGroups">
          <s:form action="add-to-group" namespace="/user" theme="simple" onsubmit="ajaxSubmit(this,'mappings-content'); return false;">
            <s:token/>
              ...
              <td>
                <table class="membership-management" cellpadding="0" cellspacing="0">
                  ...
                  <s:if test="not key.rootGroup">
                    <tr>
                      <td class="removeFromGroup">
                        <s:form action="remove-from-group" namespace="/user" theme="simple" onsubmit="ajaxSubmit(this,'mappings-content'); return false;">
                          <s:hidden name="userId" value="%{model.id}"/>
              ...
              <td>
                ...
                <s:iterator var="role" value="value">
                    ...
                    <tr>
                      ...
                      <td class="roleDismiss">
                        <s:form action="dismiss-role" namespace="/user" theme="simple" onsubmit="ajaxSubmit(this,'mappings-content'); return false;">
                          <s:token/>
                          <s:hidden name="userId" value="%{model.id}"/>
                          <s:hidden name="groupId" value="%{#mapping.key.id}"/>
                  ...
                  <tr>
                    ...
                    <td class="roleAssign">
                      <s:if test="%{not #attr.unassignedRoleMap[#mapping.key.id].isEmpty}">
                        ...
                        <s:form action="assign-role" namespace="/user" theme="simple" onsubmit="ajaxSubmit(this,'mappings-content'); return false;">
                          <s:token/>
                          <s:hidden name="userId" value="%{model.id}"/>
                          <s:hidden name="groupId" value="%{#mapping.key.id}"/>
