...
<voms:panel id="personalInformation" 
      ...
      <s:form>
        <s:textfield name="name" disabled="true" label="Name" size="30" labelposition="top" cssClass="text"/>
        <s:textfield name="surname" disabled="true" label="Surname" size="30" cssClass="text"/>
        <s:textfield name="institution" disabled="true" label="Institution" size="30" cssClass="text"/>
        <s:textarea name="address" disabled="true" label="Address" rows="4" cols="30"   cssClass="text"/>
        <s:textfield name="phoneNumber" disabled="true" label="Phone" size="30"   cssClass="text"/>
        <s:textfield name="emailAddress" disabled="true" label="Email" size="30"   cssClass="text"/>
