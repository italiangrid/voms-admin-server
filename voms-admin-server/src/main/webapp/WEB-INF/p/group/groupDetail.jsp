...
<h1>
  ...
  <voms:authorized
    ...
    <s:a
      href="%{editACLURL}"
      cssClass="actionLink"
      cssStyle="margin-left:1em">View ACL</s:a>
  </voms:authorized>
</h1>
  ...
  <voms:div
    ...
    <div>
      <s:form
        ...
        <s:hidden
          name="searchData.groupId"
          value="%{id}"
          id="groupSearchGroupId" />
        <s:textfield
