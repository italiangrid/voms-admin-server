...
public class PeriodicNotificationsTimeStorage implements
  NotificationTimeStorage {
  ...
  public long getLastNotificationTime() {
    ...
    PeriodicNotifications pn = dao.findByNotificationType(notificationKey);
  ...
  public void setLastNotificationTime(long notificationTime) {
    ...
    dao.storeLastNotificationTime(notificationKey, new Date(notificationTime));
  }
