...
public class X509ClientAuthnInterceptor extends AbstractInterceptor {
  ...
  public static final String DEFAULT_RESULT_NAME = "authnInfo";
  ...
  public String intercept(ActionInvocation invocation) throws Exception {
    ...
    if (CurrentAdmin.instance()
      ...
      if (raiseException) {
        throw new VOMSException("X.509 client authentication required");
      }
