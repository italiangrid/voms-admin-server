...
public class SAMLResponseFactory {
  ...
  private static Logger logger = LoggerFactory
    .getLogger(SAMLResponseFactory.class);
  ...
  static {
    ...
    statusMapper.put(VersionMismatchException.class,
      new String[] { StatusCode.VERSION_MISMATCH_URI });
    statusMapper.put(UnknownAttributeException.class, new String[] {
      StatusCode.REQUESTER_URI, StatusCode.UNKNOWN_ATTR_PROFILE_URI });
    statusMapper.put(UnknownPrincipalException.class, new String[] {
      StatusCode.REQUESTER_URI, StatusCode.UNKNOWN_PRINCIPAL_URI });
    statusMapper.put(UnauthorizedQueryException.class, new String[] {
      StatusCode.REQUESTER_URI, StatusCode.REQUEST_DENIED_URI });
    statusMapper.put(X509SubjectWrongNameIDValueException.class,
      new String[] { StatusCode.REQUESTER_URI });
    statusMapper.put(X509SubjectWrongNameIDFormatException.class,
      new String[] { StatusCode.REQUESTER_URI });
    statusMapper.put(IssuerPeerMismatchException.class,
      new String[] { StatusCode.REQUESTER_URI });
    statusMapper.put(SuspendedCertificateException.class, new String[] {
      StatusCode.REQUESTER_URI, StatusCode.REQUEST_DENIED_URI });
    statusMapper.put(SuspendedUserException.class, new String[] {
      StatusCode.REQUESTER_URI, StatusCode.REQUEST_DENIED_URI });
    statusMapper
      .put(Exception.class, new String[] { StatusCode.RESPONDER_URI });
  }

  public SAMLResponseFactory(X500Principal principal) {

    logger.info("Configuring ResponseFactory with issuer "
      + principal.getName());
    issuer = principal;
  }
